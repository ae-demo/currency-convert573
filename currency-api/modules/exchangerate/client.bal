...
# Subset derived from exchangerate.host's published documentation (https://exchangerate.host/documentation), covering only the currency conversion operation this project calls. Authentication is an access_key query parameter, per that documentation.
public isolated client class Client {
    ...
    public isolated function init(ConnectionConfig config =  {}, string serviceUrl = "https://api.exchangerate.host") returns error? {
    ...
    resource isolated function get convert(map<string|string[]> headers = {}, *ConvertCurrencyQueries queries) returns inline_response_200|error {
...
# Represents the Queries record for the operation: convertCurrency
public type ConvertCurrencyQueries record {
